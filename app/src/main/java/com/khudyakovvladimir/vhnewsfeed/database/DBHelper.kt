    ...
    fun createDatabase() {
        ...
        if (sharedPreferences.contains("database")) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                newsDatabase.newsDAO().insertNewsEntity(NewsEntity(1, "title", "text", "https://yandex.ru/images/search?text=photo&from=tabbar&pos=4&img_url=https%3A%2F%2Foboi.ws%2Foriginals%2Foriginal_5834_oboi_bolota_na_fone_gor_4500x3008.jpg&rpt=simage"))
            }
        }
